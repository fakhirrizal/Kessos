                        ...
                        <div class="tab-content">
                            ...
                            <div class="panel panel-flat panel-dayasos-portal">
                                <div class="panel-heading">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="<?=base_url('data_peta_kabupaten');?>" method="post">
                ...
                function initMap() {
                    ...
                    <?php
                        foreach ($data_marker as $key => $value) {
                            ...
                            $direct_url = site_url().'data_peta_kecamatan/'.$id_enkrip;
                            echo ("addMarker($lat, $lon, '<div $style><h3><b>$nama</b></h3><br><table $class_table><tbody><tr><td $style_td> Persentase Realisasi $judul </td><td> $persentase_realisasi% </td></tr><tr><td></td><td></td></tr><tr></tbody></table><a href=$direct_url>Klik disini untuk data detail</a></div>');\n");
                        }
                    ?>
