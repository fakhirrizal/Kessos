                ...
                function initMap() {
                    ...
                    <?php
                        foreach ($data_marker as $key => $value) {
                            ...
                            echo ("addMarker($lat, $lon, '<div $style><h3><b>$nama</b></h3><br><table $class_table><tbody><tr><td $style_td> Jumlah $judul </td><td> $persentase_realisasi $eee </td></tr><tr><td></td><td></td></tr><tr></tbody></table></div>');\n");
                        }
                    ?>
