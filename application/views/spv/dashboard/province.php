	...
	function initMap() {
		...
		<?php
			foreach ($data_all as $key => $value) {
				...
				$id_enkrip = md5($id);
				$url = site_url('spv/peta_kabupaten/'.$id_enkrip);
										...
										<tbody>
											...
											foreach ($data_all as $key => $value) {
												...
												<tr>
													...
													<td><a href="'.site_url().'spv/peta_kabupaten/'.md5($value->id_kabupaten).'">'.$value->nm_kabupaten.'</a></td>
													...
													<td style="text-align: center;">
														<a class="btn btn-xs green" href="'.site_url().'spv/peta_kabupaten/'.md5($value->id_kabupaten).'">
