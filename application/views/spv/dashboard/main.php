										...
										<tbody>
											...
											foreach ($data_all as $key => $value) {
												...
												<tr>
													...
													<td><a href="'.site_url().'spv/peta_provinsi/'.md5($value->id_provinsi).'">'.$value->nm_provinsi.'</a></td>
													...
													<td style="text-align: center;">
														<a class="btn btn-xs green" href="'.site_url().'spv/peta_provinsi/'.md5($value->id_provinsi).'">
