			...
			<div class="portlet light ">
				<div class="portlet-body">
					<div class="table-toolbar">
						<div class="row">
							<div class="col-md-12">
                                <form action="<?=base_url('spv/dasbor_grafik');?>" method="post">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data_utama_1b as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="'.site_url().'spv/dasbor_grafik_provinsi/'.md5($value->id_provinsi).'/'.$penanda.'">'.$value->nm_provinsi.'</a></td>
                                                ...
                                                <td style="text-align: center;">
                                                    <a class="btn btn-xs green" href="'.site_url().'spv/dasbor_grafik_provinsi/'.md5($value->id_provinsi).'/'.$penanda.'">
