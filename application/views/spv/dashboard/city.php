	...
	function initMap() {
		...
		<?php
			foreach ($data_all as $key => $value) {
				...
				$id_enkrip = md5($id);
				$url = site_url('spv/peta_kecamatan/'.$id_enkrip);
										...
										<tbody>
											...
											foreach ($data_all as $key => $value) {
												...
												<tr>
													...
													<td><a href="'.site_url().'spv/peta_kecamatan/'.md5($value->id_kecamatan).'">'.$value->nm_kecamatan.'</a></td>
													...
													<td style="text-align: center;">
														<a class="btn btn-xs green" href="'.site_url().'spv/peta_kecamatan/'.md5($value->id_kecamatan).'">
