			...
			<div class="portlet light ">
				<div class="portlet-body">
					<div class="table-toolbar">
						<div class="row">
                            <div class="col-md-12">
                                <form action="<?=base_url('spv/dasbor_grafik_kabupaten/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>" method="post">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data_utama_1 as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="'.site_url().'spv/dasbor_grafik_kecamatan/'.md5($value->id_kecamatan).'/'.$penanda.'">'.$value->nm_kecamatan.'</a></td>
                                                ...
                                                <td style="text-align: center;">
                                                    <a class="btn btn-xs green" href="'.site_url().'spv/dasbor_grafik_kecamatan/'.md5($value->id_kecamatan).'/'.$penanda.'">
