...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<span><a href='<?= site_url('/spv/rutilahu'); ?>'>Data Rutilahu (Rumah Tidak Layak Huni)</a></span>
		<i class="fa fa-circle"></i>
	</li>
	<li>
			...
			<div class="portlet light ">
				<div class="portlet-body">
					<div class='row'>
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."spv/rutilahu"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="box box-primary">
						<form role="form" class="form-horizontal" action="<?=base_url('spv/simpan_data_anggota_rutilahu');?>" method="post">
	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function(){
			$('#tbl1').dataTable({
				...
				"bProcessing": true,
				"ajax" : {
					url:"<?= site_url('spv/Master/json_anggota_rutilahu'); ?>",
