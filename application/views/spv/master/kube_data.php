						...
						<!-- <div class="row">
							<div class="col-md-6">
								<div class="btn-group">
									...
									<a href="<?=base_url('spv/tambah_data_kube');?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
								...
								<td>
									<div class="btn-group" style="text-align: center;">
										...
										<ul class="dropdown-menu" role="menu">
											<li>
												<a href="<?=site_url('spv/detail_data_kube/');?>">
													<i class="icon-eye"></i> Detail Data </a>
											</li>
											<li>
												<a href="<?=site_url('spv/ubah_data_kube/');?>">
													<i class="icon-wrench"></i> Ubah Data </a>
											</li>
											<li>
												<a onclick="return confirm('Anda yakin?')" href="<?=site_url('spv/hapus_data_kube/');?>">
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"bProcessing": true,
								"ajax" : {
									url:"<?= site_url('spv/Master/json_kube'); ?>"
								},
