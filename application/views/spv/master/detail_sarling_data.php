...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<span><a href='<?= site_url('/spv/sarling'); ?>'>Data Sarling (Sarana Lingkungan)</a></span>
		<i class="fa fa-circle"></i>
	</li>
	<li>
			...
			<div class="portlet light ">
				<div class="portlet-body">
					<div class='row'>
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."spv/sarling"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function(){
			$('#tbl1').dataTable({
				...
				"bProcessing": true,
				"ajax" : {
					url:"<?= site_url('spv/Master/json_anggota_sarling'); ?>",
