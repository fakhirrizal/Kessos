<div class="alert alert-info alert-dismissible" role="alert" style="text-align: justify;">
	...
	<i class="fa fa-warning"></i> <strong>Selamat Datang</strong> di Direktorat Fakir Miskin, Subdirektorat Perkotaan Wilayah II</a>
</div>
			...
			<div class="portlet light ">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject font-dark bold">Profil Direktorat Fakir Miskin, Subdirektorat Perkotaan Wilayah II</span>
					</div>
				</div>
				<div class="portlet-body">
					<article>
						...
						<h4>Fungsi</h4>
						<div dir="ltr"><br></div>
						<p>Dalam melaksanakan tugas sebagaimana dimaksud di atas, Kementerian Sosial menyelenggarakan fungsi sebagai berikut:</p>
						<div dir="ltr"></div>
						<ol class="decimal">
							...
							<li>Pelaksanaan dukungan yang bersifat substantif kepada seluruh unsur organisasi di lingkungan Kementerian Sosial.<p>&nbsp;</p></li>
						</ol>
						<div dir="ltr"><br></div>
					</article>
