	...
	function initMap() {
		...
		<?php
			foreach ($data_marker as $key => $value) {
				...
				$id_enkrip = md5($id);
				$url = site_url('admin_side/peta_kabupaten/'.$id_enkrip);
						...
						<tbody>
							...
							<tr class="row">
								...
								<td class="name darken">
									<a href="#pilpres:1">Kota Jakarta Timur</a>
								</td>
							...
							<tr class="row">
								<td class="idx">2.</td>
								<td class="name darken">
									<a href="#pilpres:6728">Kota Jakarta Pusat</a>
								</td>
							...
							<tr class="row">
								<td class="idx">3</td>
								<td class="name darken">
									<a href="#pilpres:12920">Kota Jakarta Utara</a>
								</td>
								<td class="sum pas pas1 per ">
							...
							<tr class="row">
								<td class="idx">4</td>
								<td class="name darken">
									<a href="#pilpres:12920">Kota Jakarta Selatan</a>
								</td>
								<td class="sum pas pas1 per ">
									<span class="abs">310.728</span><span class="per"> (21,01%)</span>
								</td>
								<td class="sum pas pas2 per win">
									<span class="abs">2.476.222</span><span class="per"> (85,95%)</span>
								</td>
								<td class="sum sah error">
									<span class="sah">2.333.305</span>
								</td>
								<td class="sum tsah">
									<span class="tsah">43.324</span>
								</td>
							...
							<tr class="row">
								<td class="idx">5</td>
								<td class="name darken">
									<a href="#pilpres:12920">Kota Jakarta Barat</a>
								</td>
								<td class="sum pas pas1 per ">
									<span class="abs">197.728</span><span class="per"> (14,05%)</span>
								</td>
								<td class="sum pas pas2 per win">
									<span class="abs">5.491.210</span><span class="per"> (85,95%)</span>
								</td>
								<td class="sum sah error">
									<span class="sah">1.178.305</span>
								</td>
								<td class="sum tsah">
									<span class="tsah">43.324</span>
								</td>
							...
							<tr class="row">
								<td class="idx">6</td>
								<td class="name darken">
									<a href="#pilpres:12920">Kabupaten Kepulauan Seribu</a>
								</td>
								<td class="sum pas pas1 per ">
									<span class="abs">411.913</span><span class="per"> (11,91%)</span>
								</td>
								<td class="sum pas pas2 per win">
									<span class="abs">1.376.300</span><span class="per"> (85,95%)</span>
								</td>
								<td class="sum sah error">
									<span class="sah">2.776.946</span>
								</td>
								<td class="sum tsah">
									<span class="tsah">23.127</span>
								</td>
							</tr>
						</tbody>
					</table>
