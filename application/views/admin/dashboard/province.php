	...
	function initMap() {
		...
		<?php
			foreach ($data_all as $key => $value) {
				...
				echo ("addMarker($lat, $lon, '<div $style><h3><b>$nama</b></h3><br><table $class_table><tbody><tr><td $style_td> Persentase Realisasi KUBE </td><td> $persentase_kube% </td></tr><tr><td $style_td> Persentase Realisasi RUTILAHU </td><td> $persentase_rutilahu% </td></tr><tr><td $style_td> Persentase Realisasi SARLING </td><td> $persentase_sarling% </td></tr><tr><td></td><td></td></tr><tr></tbody></table><a href=$url>Klik disini untuk data detail</a></div>');\n");
			}
		?>
										...
										<tbody>
											...
											foreach ($data_all as $key => $value) {
												...
												<tr>
													...
													<td><a href="'.site_url().'admin_side/peta_kabupaten/'.md5($value->id_kabupaten).'">'.$value->nm_kabupaten.'</a></td>
													...
													<td style="text-align: center;">
														<a class="btn btn-xs green" href="'.site_url().'admin_side/peta_kabupaten/'.md5($value->id_kabupaten).'">
