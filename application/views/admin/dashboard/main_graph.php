                                ...
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            ...
                                            <div class="widget-thumb-body">
                                                <!-- <span class="widget-thumb-subtitle">Kelompok</span> -->
                                                <span class="widget-thumb-body-stat"><?= number_format(($d2/$d1),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            ...
                                            <div class="widget-thumb-body">
                                                <!-- <span class="widget-thumb-subtitle">Kelompok</span> -->
                                                <span class="widget-thumb-body-stat"><?= number_format(($e2/$e1),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            ...
                                            <div class="widget-thumb-body">
                                                <!-- <span class="widget-thumb-subtitle">Tim</span> -->
                                                <span class="widget-thumb-body-stat"><?= number_format(($f2/$f1),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            ...
                                            <div class="widget-thumb-body">
                                                <!-- <span class="widget-thumb-subtitle">Kelompok</span> -->
                                                <span class="widget-thumb-body-stat"><?= number_format((($d2/$d1)/(count($data_utama_2b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            ...
                                            <div class="widget-thumb-body">
                                                <!-- <span class="widget-thumb-subtitle">Kelompok</span> -->
                                                <span class="widget-thumb-body-stat"><?= number_format((($e2/$e1)/(count($data_utama_2b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            ...
                                            <div class="widget-thumb-body">
                                                <!-- <span class="widget-thumb-subtitle">Tim</span> -->
                                                <span class="widget-thumb-body-stat"><?= number_format((($f2/$f1)/(count($data_utama_2b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-green icon-grid"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-subtitle"><?= 'Rp '.number_format(($g1/$g3),2); ?></span>
                                                <span class="widget-thumb-body-stat"><?= number_format(($g2/$g3),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-red icon-home"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-subtitle"><?= 'Rp '.number_format(($h1/$h3),2); ?></span>
                                                <span class="widget-thumb-body-stat"><?= number_format(($h2/$h3),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-purple icon-layers"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-subtitle"><?= 'Rp '.number_format(($i1/$i3),2); ?></span>
                                                <span class="widget-thumb-body-stat"><?= number_format(($i2/$i3),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-green icon-grid"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-subtitle"><?= 'Rp '.number_format((($g1/$g3)/(count($data_utama_3b))),2); ?></span>
                                                <span class="widget-thumb-body-stat"><?= number_format((($g2/$g3)/(count($data_utama_3b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-red icon-home"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-subtitle"><?= 'Rp '.number_format((($h1/$h3)/(count($data_utama_3b))),2); ?></span>
                                                <span class="widget-thumb-body-stat"><?= number_format((($h2/$h3)/(count($data_utama_3b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-purple icon-layers"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-subtitle"><?= 'Rp '.number_format((($i1/$i3)/(count($data_utama_3b))),2); ?></span>
                                                <span class="widget-thumb-body-stat"><?= number_format((($i2/$i3)/(count($data_utama_3b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-green icon-grid"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-body-stat"><?= number_format(($j1/$j2),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-red icon-home"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-body-stat"><?= number_format(($k1/$k2),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-purple icon-layers"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-body-stat"><?= number_format(($l1/$l2),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-green icon-grid"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-body-stat"><?= number_format((($j1/$j2)/(count($data_utama_4b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-red icon-home"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-body-stat"><?= number_format((($k1/$k2)/(count($data_utama_4b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="widget-thumb widget-bg-color-white margin-bottom-20 ">
                                        ...
                                        <div class="widget-thumb-wrap">
                                            <i class="widget-thumb-icon bg-purple icon-layers"></i>
                                            <div class="widget-thumb-body">
                                                <span class="widget-thumb-body-stat"><?= number_format((($l1/$l2)/(count($data_utama_4b))),2).'%'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
