			...
			<div class="portlet light ">
				<div class="portlet-body">
					<div class="table-toolbar">
						<div class="row">
                            <div class="col-md-12">
                                <form action="<?=base_url('admin_side/dasbor_grafik_kecamatan/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>" method="post">
                            ...
                            <h3><b>Jumlah Kube, RLTH, dan Sarling Kecamatan <?= $data_kecamatan->nm_kecamatan; ?> Tahun <?= $periode; ?></b></h3><br>
                            </div>
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    // subtitle: {
                                    //     text: 'Jumlah Kube, RLTH, dan Sarling Kecamatan <?= $data_kecamatan->nm_kecamatan; ?> Tahun <?= $periode; ?>'
                                    // },
                                    xAxis: {
                                        categories: [
                                                        <?php
                            ...
                            <hr>
                            <div style='text-align: center'>
                            <h3><b>Rekap Realisasi Program Kube, RLTH dan Sarling Kecamatan <?= $data_kecamatan->nm_kecamatan; ?> Tahun <?= $periode; ?></b></h3><br>
                            </div>
                            <div class="row widget-row">
                                <div class="col-md-4">
                                    <div class="widget-thumb text-uppercase margin-bottom-20 " style="background-color:#32C5D2">
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    // subtitle: {
                                    //     text: 'Rekap Realisasi Program Kube, RLTH dan Sarling Kecamatan <?= $data_kecamatan->nm_kecamatan; ?> Tahun <?= $periode; ?>'
                                    // },
                                    xAxis: {
                                        categories: [
                                                        <?php
                            ...
                            <hr>
                            <div style='text-align: center'>
                            <h3><b>Rekap Serapan Bantuan Keuangan untuk Program Kube, RLTH dan Sarling Kecamatan <?= $data_kecamatan->nm_kecamatan; ?> Tahun <?= $periode; ?></b></h3><br>
                            </div>
                            <div class="row widget-row">
                                <div class="col-md-4">
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    // subtitle: {
                                    //     text: 'Rekap Serapan Bantuan Keuangan untuk Program Kube, RLTH dan Sarling Kecamatan <?= $data_kecamatan->nm_kecamatan; ?> Tahun <?= $periode; ?>'
                                    // },
                                    xAxis: {
                                        categories: [
                                                        <?php
                            ...
                            <hr>
                            <div style='text-align: center'>
                            <h3><b>Rekap Progress Fisik Program Kube, RLTH dan Sarling Kecamatan <?= $data_kecamatan->nm_kecamatan; ?> Tahun <?= $periode; ?></b></h3><br>
                            </div>
                            <div class="row widget-row">
                                <div class="col-md-4">
                                    <div class="widget-thumb margin-bottom-20 " style="background-color:#32C5D2">
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    // subtitle: {
                                    //     text: 'Rekap Progress Fisik Program Kube, RLTH dan Sarling Kecamatan <?= $data_kecamatan->nm_kecamatan; ?> Tahun <?= $periode; ?>'
                                    // },
                                    xAxis: {
                                        categories: [
                                                        <?php
