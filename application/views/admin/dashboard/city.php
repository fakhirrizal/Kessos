										...
										<tbody>
											...
											foreach ($data_all as $key => $value) {
												...
												<tr>
													...
													<td><a href="'.site_url().'admin_side/peta_kecamatan/'.md5($value->id_kecamatan).'">'.$value->nm_kecamatan.'</a></td>
													...
													<td style="text-align: center;">
														<a class="btn btn-xs green" href="'.site_url().'admin_side/peta_kecamatan/'.md5($value->id_kecamatan).'">
