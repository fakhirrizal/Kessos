						...
						<div class="row">
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    subtitle: {
                                        text: 'Jumlah Kube, RLTH, dan Sarling'
                                    },
                                    xAxis: {
                                        categories: [
                                                        <?php
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    subtitle: {
                                        text: 'Rekap Realisasi Program Kube, RLTH dan Sarling'
                                    },
                                    xAxis: {
                                        categories: [
                                                        <?php
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    subtitle: {
                                        text: 'Rekap Serapan Bantuan Keuangan untuk Program Kube, RLTH dan Sarling'
                                    },
                                    xAxis: {
                                        categories: [
                                                        <?php
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    subtitle: {
                                        text: 'Rekap Progress Fisik Program Kube, RLTH dan Sarling'
                                    },
                                    xAxis: {
                                        categories: [
                                                        <?php
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    subtitle: {
                                        text: 'Jenis Usaha Kube di Seluruh Provinsi'
                                    },
                                    xAxis: {
                                        categories: ['Jumlah'],
                                        labels: {
                            ...
                            <script type="text/javascript">
                                $('.grafik').highcharts({
                                    ...
                                    subtitle: {
                                        text: 'Jenis Sarling di Seluruh Provinsi'
                                    },
                                    xAxis: {
                                        categories: ['Jumlah'],
                                        labels: {
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><?= number_format($value->jumlah_kube); ?> Kelompok</td>
                                                <td style="text-align: center;"><?= number_format($value->jumlah_rutilahu); ?> Kelompok</td>
                                                <td style="text-align: center;"><?= number_format($value->jumlah_kube); ?> Tim</td>
