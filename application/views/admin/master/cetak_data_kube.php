...
<div class='entry'>
  ...
  <tr>
    <td colspan='10' style="text-align: center;">Rekap Data Kube</td>
  </tr>
  <tr>
    ...
    <td bgcolor='gren' style="text-align: center;">Jenis Usaha</td>
  ...
  header("Content-Disposition: attachment; filename=rekap_data_kube.xls");
  ?>
  </table>
</div>