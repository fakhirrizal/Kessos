		...
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<div class="col-md-12">
						<form method='post' action='<?=site_url('admin_side/laporan_sarling');?>'>
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"ajax" : {
									type:"POST",
									url: "<?php echo site_url('admin/Report/json_sarling')?>",
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-body">
					<div class="row">
						<form method='post' action='<?=base_url('admin/Report/download_sarling_data');?>'>
