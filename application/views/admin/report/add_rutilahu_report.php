...
<script type="text/javascript">
	$(function(){
		...
		$("#id_rutilahu").change(function(){
			var value=$(this).val();
			$.ajax({
				data:{id:value,modul:'get_isian_rencana_anggaran_pengadaan_by_id_rutilahu'},
				success: function(respond){
		...
		$("#id_rutilahu").change(function(){
			var value=$(this).val();
			$.ajax({
				data:{id:value,modul:'get_isian_rencana_anggaran_proses_by_id_rutilahu'},
				success: function(respond){
		...
		$("#id_rutilahu").change(function(){
			var value=$(this).val();
			$.ajax({
				data:{id:value,modul:'get_isian_rencana_anggaran_benefit_by_id_rutilahu'},
				success: function(respond){
