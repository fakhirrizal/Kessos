								...
								<div class="col-md-10">
									<select name='id_rutilahu' id='id_rutilahu' class="form-control select2-allow-clear" required>
										...
										foreach ($rutilahu as $key => $value) {
											echo '<option value="'.$value->id_rutilahu.'">'.$value->nama_tim.' - '.$value->nm_kabupaten.'</option>';
										}
										?>
									</select>
								</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<select name='id_anggota_rutilahu' id='id_anggota_rutilahu' class="form-control select2-allow-clear" required>
											<option value=''></option>
										</select>
									</div>
								</div>
