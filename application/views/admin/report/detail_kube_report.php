			...
			<div class="portlet light ">
				<div class="portlet-body">
					<div class='row'>
												...
												<td>
													<div class="dropdown">
														...
														<ul class="dropdown-menu pull-right" role="menu">
															<li>
																<a href="'.site_url('admin_side/ubah_data_laporan_kube/'.md5($value->id_laporan_kube)).'">
																	<i class="icon-wrench"></i> Ubah Data </a>
															</li>
															<li>
																<a onclick="'.$return_on_click.'" href="'.site_url('admin_side/hapus_data_laporan_kube/'.md5($value->id_laporan_kube)).'">
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."admin_side/laporan_kube"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
