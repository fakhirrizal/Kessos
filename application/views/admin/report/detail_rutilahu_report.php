								...
								<table class="table table-striped table-bordered" id="tbl1">
									...
									<tbody>
										...
										foreach ($data_detail_laporan as $key => $value) {
											...
											$detail_laporan = $this->Main_model->getSelectedData('detail_laporan_rutilahu a', 'a.*,b.master_indikator', array('a.id_laporan_rutilahu'=>$value->id_laporan_rutilahu),'','','','',array(
