...
<div class="page-content-inner">
			...
			<div class="portlet light ">
				<div class="portlet-body">
					...
					<div class='row'>
						...
						<div class="col-md-12" >
							<div class="tabbable-line">
								<div class="table-toolbar">
									<div class="row">
										<div class="col-md-6">
											<a href="<?php echo site_url('member_side/tambah_laporan_sarling'); ?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
										</div>
									</div>
								</div>
												...
												<td>
													<div class="dropdown">
														...
														<ul class="dropdown-menu pull-right" role="menu">
															<li>
																<a href="'.site_url('member_side/ubah_data_laporan_sarling/'.md5($value->id_laporan_sarling)).'">
																	<i class="icon-wrench"></i> Ubah Data </a>
															</li>
															<li>
																<a onclick="'.$return_on_click.'" href="'.site_url('member_side/hapus_data_laporan_sarling/'.md5($value->id_laporan_sarling)).'">
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."member_side/laporan_sarling"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" language="javascript" >
		...
		// 		"bProcessing": true,
		// 		"ajax" : {
		// 			url:"<?= site_url('member/Report/json_laporan_sarling'); ?>",
