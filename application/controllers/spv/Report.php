...
class Report extends CI_Controller {
    ...
    public function kube(){
        ...
        $this->load->view('spv/report/kube',$data);
    ...
    public function json_kube(){
        ...
        $get_data = $this->Main_model->getSelectedData('kube a', 'a.*,b.jenis_usaha,c.nm_provinsi,d.nm_kabupaten,e.nm_kecamatan,f.nm_desa,g.*',$where_wilayah,'','','','',array(
            array(
                'table' => 'jenis_usaha b',
            ...
            $isi['aksi'] =	'
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li>
                                            <a href="'.site_url('spv/detil_laporan_kube/'.md5($value->id_kube)).'">
    ...
    public function add_kube_report(){
        ...
        $data['kube'] = $this->Main_model->getSelectedData('kube a', 'a.*,e.nm_kabupaten,j.jenis_usaha', $where_wilayah,'','','','',array(
            array(
                'table' => 'kabupaten e',
        ...
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/add_kube_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function save_kube_report(){
        ...
        if($this->db->trans_status() === false){
            ...
            echo "<script>window.location='".base_url()."spv/tambah_laporan_kube/'</script>";
        }
        else{
            ...
            echo "<script>window.location='".base_url()."spv/laporan_kube/'</script>";
        }
    }
    public function detail_kube_report()
    {
        ...
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/detail_kube_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function edit_kube_report(){
        ...
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/edit_kube_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function update_kube_report(){
        ...
        if($this->db->trans_status() === false){
            ...
            echo "<script>window.location='".base_url()."spv/ubah_data_laporan_kube/".$this->input->post('id_laporan_kube')."'</script>";
        }
        else{
            ...
            echo "<script>window.location='".base_url()."spv/detil_laporan_kube/".$this->input->post('id_kube')."'</script>";
        }
    }
    public function delete_kube_report(){
        ...
        if($this->db->trans_status() === false){
            ...
            echo "<script>window.location='".base_url()."spv/detil_laporan_kube/".md5($get_data->id_kube)."'</script>";
        }
        else{
    ...
    public function rutilahu(){
        ...
        $data['grand_child'] = '';
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/rutilahu',$data);
        $this->load->view('spv/template/footer');
    }
    public function json_rutilahu(){
        ...
        $jumlah_indikator = $this->Main_model->getSelectedData('indikator a', 'a.*')->result();
        $get_data = $this->Main_model->getSelectedData('rutilahu a', 'a.*,c.nm_provinsi,d.nm_kabupaten,e.nm_kecamatan,f.nm_desa,g.*',$where_wilayah,'','','','',array(
            array(
                'table' => 'provinsi c',
                'on' => 'a.id_provinsi=c.id_provinsi',
                'pos' => 'LEFT'
        ...
        foreach ($get_data as $key => $value) {
            ...
            $isi['aksi'] =	'
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li>
                                            <a href="'.site_url('spv/detil_laporan_rutilahu/'.md5($value->id_rutilahu)).'">
                                                <i class="icon-eye"></i> Detil Data </a>
                                        </li>
                                    </ul>
                                </div>
    ...
    public function add_rutilahu_report(){
        ...
        $data['rutilahu'] = $this->Main_model->getSelectedData('rutilahu a', 'a.*,e.nm_kabupaten', $where_wilayah,'','','','',array(
            'table' => 'kabupaten e',
            'on' => 'a.id_kabupaten=e.id_kabupaten',
            'pos' => 'left'
        ))->result();
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/add_rutilahu_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function save_rutilahu_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/tambah_laporan_rutilahu/'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/laporan_rutilahu/'</script>";
        }
    }
    public function detail_rutilahu_report()
    {
        ...
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/detail_rutilahu_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function edit_rutilahu_report(){
        ...
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/edit_rutilahu_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function update_rutilahu_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/ubah_data_laporan_rutilahu/".$this->input->post('id_laporan_rutilahu')."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/detil_laporan_rutilahu/".$this->input->post('id_rutilahu')."'</script>";
        }
    }
    public function delete_rutilahu_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/detil_laporan_rutilahu/".md5($get_data->id_rutilahu)."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/detil_laporan_rutilahu/".md5($get_data->id_rutilahu)."'</script>";
    ...
    public function sarling(){
        ...
        $data['grand_child'] = '';
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/sarling',$data);
        $this->load->view('spv/template/footer');
    }
    public function json_sarling(){
        ...
        $jumlah_indikator = $this->Main_model->getSelectedData('indikator a', 'a.*')->result();
        $get_data = $this->Main_model->getSelectedData('sarling a', 'a.*,c.nm_provinsi,d.nm_kabupaten,e.nm_kecamatan,f.nm_desa,g.*',$where_wilayah,'','','','',array(
            array(
                'table' => 'provinsi c',
                'on' => 'a.id_provinsi=c.id_provinsi',
                'pos' => 'LEFT'
        ...
        foreach ($get_data as $key => $value) {
            ...
            $isi['aksi'] =	'
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li>
                                            <a href="'.site_url('spv/detil_laporan_sarling/'.md5($value->id_sarling)).'">
                                                <i class="icon-eye"></i> Detil Data </a>
                                        </li>
                                    </ul>
                                </div>
    ...
    public function add_sarling_report(){
        ...
        $data['sarling'] = $this->Main_model->getSelectedData('sarling a', 'a.*,e.nm_kabupaten', $where_wilayah,'','','','',array(
            'table' => 'kabupaten e',
            'on' => 'a.id_kabupaten=e.id_kabupaten',
            'pos' => 'left'
        ))->result();
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/add_sarling_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function save_sarling_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/tambah_laporan_sarling/'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/laporan_sarling/'</script>";
        }
    }
    public function detail_sarling_report()
    {
        ...
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/detail_sarling_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function edit_sarling_report(){
        ...
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('spv/template/header',$data);
        $this->load->view('spv/report/edit_sarling_report',$data);
        $this->load->view('spv/template/footer');
    }
    public function update_sarling_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/ubah_data_laporan_sarling/".$this->input->post('id_laporan_sarling')."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/detil_laporan_sarling/".$this->input->post('id_sarling')."'</script>";
        }
    }
    public function delete_sarling_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/detil_laporan_sarling/".md5($get_data->id_sarling)."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."spv/detil_laporan_sarling/".md5($get_data->id_sarling)."'</script>";
