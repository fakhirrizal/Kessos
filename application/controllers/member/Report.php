...
class Report extends CI_Controller {
    ...
    public function add_kube_report(){
        ...
        $this->load->view('member/report/add_kube_report',$data);
    ...
    public function save_kube_report(){
        ...
        if($this->db->trans_status() === false){
            ...
            echo "<script>window.location='".base_url()."member_side/tambah_laporan_kube/'</script>";
        }
        else{
            ...
            echo "<script>window.location='".base_url()."member_side/detil_laporan_kube/".md5($this->input->post('id_kube'))."'</script>";
        }
    }
    public function detail_kube_report()
    {
        $data['parent'] = 'report';
        $data['child'] = 'detail_kube';
        $data['grand_child'] = '';
        ...
        $this->load->view('member/template/header',$data);
        $this->load->view('member/report/detail_kube_report',$data);
        $this->load->view('member/template/footer');
    }
    public function edit_kube_report(){
        ...
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('member/template/header',$data);
        $this->load->view('member/report/edit_kube_report',$data);
        $this->load->view('member/template/footer');
    }
    public function update_kube_report(){
        ...
        if($this->db->trans_status() === false){
            ...
            echo "<script>window.location='".base_url()."member_side/ubah_data_laporan_kube/".$this->input->post('id_laporan_kube')."'</script>";
        }
        else{
            ...
            echo "<script>window.location='".base_url()."member_side/detil_laporan_kube/".$this->input->post('id_kube')."'</script>";
        }
    }
    public function delete_kube_report(){
        ...
        if($this->db->trans_status() === false){
            ...
            echo "<script>window.location='".base_url()."member_side/detil_laporan_kube/".md5($get_data->id_kube)."'</script>";
        }
        else{
    ...
    public function add_rutilahu_report(){
        ...
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('member/template/header',$data);
        $this->load->view('member/report/add_rutilahu_report',$data);
        $this->load->view('member/template/footer');
    }
    public function save_rutilahu_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/tambah_laporan_rutilahu/'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil ditambahkan.<br /></div>' );
    ...
    public function detail_rutilahu_report()
    {
        ...
        $this->load->view('member/template/header',$data);
        $this->load->view('member/report/detail_rutilahu_report',$data);
        $this->load->view('member/template/footer');
    }
    public function edit_rutilahu_report(){
        ...
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('member/template/header',$data);
        $this->load->view('member/report/edit_rutilahu_report',$data);
        $this->load->view('member/template/footer');
    }
    public function update_rutilahu_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/ubah_data_laporan_rutilahu/".$this->input->post('id_laporan_rutilahu')."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/detil_laporan_rutilahu/".$this->input->post('id_rutilahu')."'</script>";
        }
    }
    public function delete_rutilahu_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/detil_laporan_rutilahu/".md5($get_data->id_rutilahu)."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/detil_laporan_rutilahu/".md5($get_data->id_rutilahu)."'</script>";
    ...
    public function add_sarling_report(){
        ...
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('member/template/header',$data);
        $this->load->view('member/report/add_sarling_report',$data);
        $this->load->view('member/template/footer');
    }
    public function save_sarling_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/tambah_laporan_sarling/'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/detail_laporan_sarling/".md5($this->input->post('id_sarling'))."'</script>";
        }
    }
    public function detail_sarling_report()
    {
        $data['parent'] = 'report';
        $data['child'] = 'detail_sarling';
        $data['grand_child'] = '';
        ...
        $this->load->view('member/template/header',$data);
        $this->load->view('member/report/detail_sarling_report',$data);
        $this->load->view('member/template/footer');
    }
    public function edit_sarling_report(){
        ...
        $data['indikator'] = $this->Main_model->getSelectedData('master_indikator a', 'a.*')->result();
        $this->load->view('member/template/header',$data);
        $this->load->view('member/report/edit_sarling_report',$data);
        $this->load->view('member/template/footer');
    }
    public function update_sarling_report(){
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/ubah_data_laporan_sarling/".$this->input->post('id_laporan_sarling')."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."member_side/detil_laporan_sarling/".$this->input->post('id_sarling')."'</script>";
        }
    }
