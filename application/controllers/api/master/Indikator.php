...
class Indikator extends REST_Controller {
	...
	function index_get() {
		if($this->get('id_tipe')!=NULL){
			$hasil = $this->Main_model->getSelectedData('indikator a', 'a.id_indikator,f.master_indikator AS tipe,a.indikator', array('a.id_master_indikator'=>$this->get('id_tipe')),'','','','',array(
