...
class Report extends REST_Controller {
	...
	// 	$get_id_laporan_rutilahu = $this->Main_model->getLastID('laporan_rutilahu','id_laporan_rutilahu');
	// 	$get_data_rutilahu = $this->Main_model->getSelectedData('rutilahu a', 'a.*', array('a.id_rutilahu'=>$this->post('id_rutilahu')))->row();
	...
	// 	$gabung_indikator = '';
	// 	$cek_laporan_rutilahu = $this->Main_model->getSelectedData('laporan_rutilahu a', 'a.*', array('a.id_rutilahu'=>$this->post('id_rutilahu'),'a.deleted'=>'0'),'a.created_at DESC','1')->row();
	// 	$explode_indikator = explode(',',$gabung_indikator);
	// 	$get_status_laporan_rutilahu = $this->Main_model->getSelectedData('status_laporan_rutilahu a', 'a.*', array('a.id_rutilahu'=>$this->post('id_rutilahu')))->row();
	// 	$persentase_fisik = (count($explode_indikator)/count($data_indikator))*100;
	// 	if($cek_laporan_rutilahu==NULL){
	...
	// 			'persentase_anggaran' => ($this->post('progres_keuangan')/$get_data_rutilahu->rencana_anggaran)*100,
	// 			'persentase_realisasi' => ((($this->post('progres_keuangan')/$get_data_rutilahu->rencana_anggaran)*100)+$persentase_fisik)/2,
	...
	// 	}else{
	// 		$a = $cek_laporan_rutilahu->indikator;
	...
	// 	}else{
	// 		$persentase_anggaran = (($this->post('progres_keuangan')+$get_status_laporan_rutilahu->anggaran)/$get_data_rutilahu->rencana_anggaran)*100;
	// 		$persentase_realisasi = ($persentase_anggaran+$persentase_fisik)/2;
	// 		$data_update1 = array(
	// 			'persentase_fisik' => $persentase_fisik,
	...
	// 	}
	// 	$this->Main_model->log_activity($get_data_anggota->user_id,'Adding data',"Add rutilahu's report data (".$get_data_rutilahu->nama_tim.") via Mobile Apps");
